...
class PartycakeLogger {
    ...
    func load(state: PartycakeState) {
        ...
        self.i1 = asciiInner(at: side1.seat, on: state)
        self.i2 = asciiInner(at: side2.seat, on: state)
        self.i3 = asciiInner(at: side3.seat, on: state)
        self.i4 = asciiInner(at: side4.seat, on: state)

        self.o1 = asciiOuter(at: side1.seat, on: state)
        self.o2 = asciiOuter(at: side2.seat, on: state)
        self.o3 = asciiOuter(at: side3.seat, on: state)
        self.o4 = asciiOuter(at: side4.seat, on: state)
    ...
    func asciiBetLevel(_ level: PartycakeBetLevel) -> String {
        switch level {
        case .min:
            return "Min"
        case .mid:
    ...
    func asciiInner(at seat: PartycakeSeat, on state: PartycakeState) -> String {
    ...
    func asciiOuter(at seat: PartycakeSeat, on state: PartycakeState) -> String {
        let seatOffset = seat.rawValue - 1
